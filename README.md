...
1. Download the latest disableRedstone.jar from the Releases page (or build the plugin from source).
2. Place the JAR file in your server's `plugins/` directory.
3. Restart your server (or reload plugins if your platform supports it).
